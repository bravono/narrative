...
export default function LearnModeSelectAnyFour({ classNameA, classNameB }) {
  // export default function LearnModeSelectAnyFour({ ...props }) {
  ...
  const goToNext = () => {
    alert("Routing to LearnModeSelectAnyFive");
