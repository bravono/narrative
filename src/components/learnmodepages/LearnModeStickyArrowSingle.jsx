...
import React from "react";
<<<<<<< HEAD:src/components/LearnModeStickyArrowSingle.jsx
import BottomButton from "./BottomButton";
import EdgeChair from "./EdgeChair";
import MiddleButton from "./MiddleButton";
import Queue from "./Queue";
...
import EdgeStanding from "../EdgeStanding";
import Logo from "../Logo";
>>>>>>> LearnModePagesRefactoring:src/components/learnmodepages/LearnModeStickyArrowSingle.jsx
import { useNavigate } from "react-router-dom";
import Button from "../Button";
import LearnButtonState from "./LearnButtonState";

export default function LearnModeStickyArrowSingle({ classNameA, classNameB }) {
