...
export default function LearnModeSelectAnyFive({ classNameA, classNameB }) {
  // export default function LearnModeSelectAnyFive({ ...props }) {
  const navigate = useNavigate();

  const goToPrevious = () => {
    alert("Routing to LearnModeSelectAnyFour");
    navigate("/LearnModeSelectAnyFour");
  };
  ...
  const goToNext = () => {
    ...
    // navigate("/LearnModeSelectAnyFive");
  };
              ...
              <div className={"contents"}>
                <div className="talkbubble-btn">
                  ...
                  <Button
                    onClick={goToNext}
                    label="NEXT"
                    className={`${classNameB} bottom_button talk-btn-exit color`}
                  />
                </div>
